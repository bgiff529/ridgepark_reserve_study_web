...
\begin{longtable}{>{\centering\arraybackslash}p{0.9cm} >{\raggedleft\arraybackslash}p{1.75cm} >{\raggedleft\arraybackslash}p{1.65cm} >{\raggedleft\arraybackslash}p{1.7cm} >{\raggedleft\arraybackslash}p{1.65cm} >{\raggedleft\arraybackslash}p{1.65cm} >{\raggedleft\arraybackslash}p{1.45cm} >{\raggedleft\arraybackslash}p{1.75cm}}
\toprule
Year & Begin & Contribution & Special Assess. & Add'l Income & Expenditures & Interest & Ending \\
\midrule
\endfirsthead
\toprule
Year & Begin & Contribution & Special Assess. & Add'l Income & Expenditures & Interest & Ending \\
